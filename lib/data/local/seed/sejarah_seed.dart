...
// 1. PERANG PUPUTAN KLUNGKUNG (28 APRIL 1908)
  SejarahModel(
    kodeTag: 'HIS-280408-1',
    tanggalKey: '280408',
    urutan: 1,
    judul: 'PERANG PUPUTAN KLUNGKUNG',
    subtitle: '28.04.08 · Perlawanan Habis-habisan Kerajaan Klungkung Melawan Kolonial Belanda',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/puputan_klungkung_cover.jpg',
    provinsi: 'Bali',
    periode: 'KLN',
    jenisPeristiwa: 'PRG',
    detailPeristiwa: {
    ...
    alurPeristiwa: [
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/puputan_klungkung_ultimatum.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
      ...
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/puputan_klungkung_laskar.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
  ...
  SejarahModel(
    kodeTag: 'HIS-200508-1',
    tanggalKey: '200508',
    urutan: 1,
    judul: 'PENDIRIAN BOEDI OETOMO',
    subtitle: '20.05.08 · Tonggak Awal Kebangkitan Nasional Indonesia Modern',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/pendirian_boedi_oetomo_cover.jpg',
    ...
    alurPeristiwa: [
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/pendirian_boedi_oetomo_pertemuan.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/pendirian_boedi_oetomo_pemberian.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/pendirian_boedi_oetomo_kongres.jpg',
        hasImage: true,
      ),
    ],
  ),
  ...
  SejarahModel(
    kodeTag: 'HIS-100912-1',
    tanggalKey: '100912',
    urutan: 1,
    judul: 'TRANSFORMASI SAREKAT ISLAM',
    subtitle: '10.09.12 · Peletakan Akta Hukum Organisasi Massa Bumiputra Terbesar',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/sarekat_islam_cover.jpg',
    provinsi: 'Jawa Timur',
    periode: 'NAS',
    jenisPeristiwa: 'ORG',
    detailPeristiwa: {
    ...
    alurPeristiwa: [
      ...
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/sarekat_islam_pidato.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
  ...
  SejarahModel(
    kodeTag: 'HIS-251212-1',
    tanggalKey: '251212',
    urutan: 1,
    judul: 'PENDIRIAN INDISCHE PARTIJ',
    subtitle: '25.12.12 · Deklarasi Partai Politik Radikal Multietnis Pertama di Nusantara',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/indische_partij_cover.jpg',
    provinsi: 'Jawa Barat',
    periode: 'NAS',
    jenisPeristiwa: 'ORG',
    detailPeristiwa: {
    ...
    alurPeristiwa: [
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/indische_partij_deklarasi.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
      ...
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/indische_partij_pengasingan.jpg',
        hasImage: true,
      ),
    ],
  ),
  ...
  SejarahModel(
    kodeTag: 'HIS-130713-1',
    tanggalKey: '130713',
    urutan: 1,
    judul: 'PENERBITAN RISALAH “ALS IK EENS NEDERLANDER WAS”',
    subtitle: '13.07.13 · Pamflet Satire Suwardi Suryaningrat Mengguncang Kolonialisme',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/als_ik_eens_nederlander_was_cover.jpg',
    provinsi: 'Jawa Barat',
    periode: 'NAS',
    jenisPeristiwa: 'NSK',
    detailPeristiwa: {
    ...
    alurPeristiwa: [
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/als_ik_eens_cetak.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
  ...
  SejarahModel(
    kodeTag: 'HIS-040727-1',
    tanggalKey: '040727',
    urutan: 1,
    judul: 'PENDIRIAN PERSERIKATAN NASIONAL INDONESIA',
    subtitle: '04.07.27 · Konsolidasi Kekuatan Nasionalis Radikal Non-Kooperasi',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/pendirian_pni_cover.jpg',
    provinsi: 'Jawa Barat',
    periode: 'NAS',
    jenisPeristiwa: 'ORG',
    detailPeristiwa: {
    ...
    alurPeristiwa: [
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/pendirian_pni_rapat.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/pendirian_pni_kongres.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
  ...
  SejarahModel(
    ...
    subtitle: '28.10.28 · Penetapan Naskah Ikrar Persatuan Bangsa pada Kongres Pemuda II',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/sumpah_pemuda_cover.jpg',
    provinsi: 'DKI Jakarta',
    periode: 'NAS',
    jenisPeristiwa: 'NSK',
    detailPeristiwa: {
    ...
    alurPeristiwa: [
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/sumpah_pemuda_perumusan.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/sumpah_pemuda_pembacaan.jpg',
        hasImage: true,
      ),
      TimelineItemModel(
        ...
        imgPath: 'assets/images/sejarah/sumpah_pemuda_ikrar.jpg',
        hasImage: true,
      ),
    ],
  ),
  ...
  SejarahModel(
    kodeTag: 'HIS-281028-2',
    tanggalKey: '281028',
    urutan: 2,
    judul: 'PERDENGARAN PERDANA LAGU INDONESIA RAYA OLEH W.R. SOEPRATMAN',
    subtitle: '28.10.28 · Gesekan Biola Penggetar Jiwa Nasionalisme di Kongres Pemuda II',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/wr_soepratman_cover.jpg',
    provinsi: 'DKI Jakarta',
    periode: 'NAS',
    jenisPeristiwa: 'TKH',
    detailPeristiwa: {
  ...
  //anjay
  SejarahModel(
    kodeTag: 'HIS-010100-1',
    tanggalKey: '010100',
    urutan: 1,
    judul: 'EKSKAVASI SITUS PURBAKALA SANGIRAN',
    subtitle: '01.01.00 · Jejak Kehidupan Manusia Purba Pleistosen di Lembah Bengawan Solo',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/situs_sangiran_cover.jpg',
  ...
  SejarahModel(
    kodeTag: 'HIS-160582-1',
    tanggalKey: '160582',
    urutan: 1,
    judul: 'PENETAPAN PRASASTI KEDUKAN BUKIT',
    subtitle: '16.05.682 · Piagam Proklamasi Pendirian Wanua Kerajaan Sriwijaya',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/prasasti_kedukan_bukit_cover.jpg',
  ...
  SejarahModel(
    kodeTag: 'HIS-220627-1',
    tanggalKey: '220627',
    urutan: 1,
    judul: 'PERANG PEMBEBASAN SUNDA KELAPA OLEH FATAHILLAH',
    subtitle: '22.06.27 · Pengusiran Armada Portugis dan Penetapan Nama Jayakarta',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/pembebasan_sunda_kelapa_cover.jpg',
    provinsi: 'DKI Jakarta',
    periode: 'ISL',
    jenisPeristiwa: 'PRG',
    detailPeristiwa: {
  ...
  SejarahModel(
    kodeTag: 'HIS-130255-1',
    tanggalKey: '130255',
    urutan: 1,
    judul: 'PENANDATANGANAN PERJANJIAN GIYANTI',
    subtitle: '13.02.55 · Pembagian Kerajaan Mataram Islam Menjadi Dua Wangsa Monarki',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/perjanjian_giyanti_cover.jpg',
    provinsi: 'Jawa Tengah',
    periode: 'KLN',
    jenisPeristiwa: 'PRJ',
    detailPeristiwa: {
  ...
  SejarahModel(
    kodeTag: 'HIS-200725-1',
    tanggalKey: '200725',
    urutan: 1,
    judul: 'PELEPASAN PERANG DIPONEGORO DI TEGALREJO',
    subtitle: '20.07.25 · Meletusnya Perang Jawa Menentang Tirani Kolonial Belanda',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/perang_diponegoro_cover.jpg',
  ...
  SejarahModel(
    ...
    subtitle: '17.08.45 · Lahirnya Negara Kesatuan Republik Indonesia Merdeka dan Berdaulat',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/proklamasi_kemerdekaan_cover.jpg',
    provinsi: 'DKI Jakarta',
    periode: 'NAS',
    jenisPeristiwa: 'NSK',
    detailPeristiwa: {
  ...
  SejarahModel(
    kodeTag: 'HIS-101145-1',
    tanggalKey: '101145',
    urutan: 1,
    judul: 'PERTEMPURAN SURABAYA 10 NOVEMBER 1945',
    subtitle: '10.11.45 · Perlawanan Semesta Arek-Arek Suroboyo Menggempur Sekutu',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/pertempuran_surabaya_cover.jpg',
    provinsi: 'Jawa Timur',
    periode: 'REV',
    jenisPeristiwa: 'PRG',
    detailPeristiwa: {
  ...
  SejarahModel(
    kodeTag: 'HIS-050759-1',
    tanggalKey: '050759',
    urutan: 1,
    judul: 'PEMBACAAN DEKRIT PRESIDEN 5 JULI 1959',
    subtitle: '05.07.59 · Pembubaran Konstituante dan Pemberlakuan Kembali UUD 1945',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/dekrit_presiden_1959_cover.jpg',
    provinsi: 'DKI Jakarta',
    periode: 'ORL',
    jenisPeristiwa: 'NSK',
    detailPeristiwa: {
  ...
  SejarahModel(
    kodeTag: 'HIS-110366-1',
    tanggalKey: '110366',
    urutan: 1,
    judul: 'PENERBITAN SURAT PERINTAH SEBELAS MARET',
    subtitle: '11.03.66 · Transisi Kekuasaan Politik Nasional Menuju Rezim Orde Baru',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/supersemar_cover.jpg',
    provinsi: 'Jawa Barat',
    periode: 'ORB',
    jenisPeristiwa: 'NSK',
    detailPeristiwa: {
  ...
  SejarahModel(
    kodeTag: 'HIS-210598-1',
    tanggalKey: '210598',
    urutan: 1,
    judul: 'PERNYATAAN BERHENTI PRESIDEN SOEHARTO',
    subtitle: '21.05.98 · Berakhirnya 32 Tahun Rezim Orde Baru dan Kelahiran Era Reformasi',
    ringkasan:
    ...
    gambarUtama: 'assets/images/sejarah/mundurnya_soeharto_cover.jpg',
    provinsi: 'DKI Jakarta',
    periode: 'REF',
    jenisPeristiwa: 'NSK',
    detailPeristiwa: {
